...
export default class Compute {
    ...
    private static pipeline(device: GPUDevice, regionArrays: RegionArrays, evaluationState: EvaluationState, outputSubintervals: boolean): GPUComputePipeline {
    ...
    constructor(device: GPUDevice, regionArrays: RegionArrays, evaluationState: EvaluationState) {
        ...
        this.pipelines = [];
        this.pipelines.push(Compute.pipeline(device, regionArrays, evaluationState, true));
        this.pipelines.push(Compute.pipeline(device, regionArrays, evaluationState, true));
        this.pipelines.push(Compute.pipeline(device, regionArrays, evaluationState, false));
    }
