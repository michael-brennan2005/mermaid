...
export class Compute {
    ...
    encode(encoder: GPUCommandEncoder, evaluationState: EvaluationState, regionArrays: RegionArrays) {
        // First pass
        const pass1 = encoder.beginComputePass({ label: "Compute - pass 1" });
        ...
        // Second pass
        const pass2 = encoder.beginComputePass({ label: "Compute - pass 2" });
        ...
        // Third pass
        const pass3 = encoder.beginComputePass({ label: "Compute - pass 3" });
